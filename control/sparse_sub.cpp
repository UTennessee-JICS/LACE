  ...
  data_d_matrix *                C)
{
  ...
  printf(
    "SPARSE_STATUS_ALLOC_FAILED=%d SPARSE_STATUS_INVALID_VALUE=%d SPARSE_STATUS_EXECUTION_FAILED=%d SPARSE_STATUS_INTERNAL_ERROR=%d SPARSE_STATUS_NOT_SUPPORTED=%d\n",
    SPARSE_STATUS_ALLOC_FAILED, SPARSE_STATUS_INVALID_VALUE, SPARSE_STATUS_EXECUTION_FAILED, SPARSE_STATUS_INTERNAL_ERROR,
