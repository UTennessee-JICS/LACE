...
int main(int argc, char* argv[])
{
  ...
  printf("\nGPU fgmres_housholder v 0.1======================:\n\n");
  data_d_gmres_log gmres_gpu_1_log;
  ...
  printf("maxthreads = %d numprocs = %d\n", maxthreads, numprocs );
  data_fgmres_householder_gpu_v_0_1( &Asparse, &rhs_vector, &x, &L, &Ucsr, &gmres_param, &gmres_gpu_1_log );
  ...
  printf("gmres_search_directions = %d;\n", gmres_gpu_1_log.search_directions );
  printf("gmres_solve_time = %e;\n", gmres_gpu_1_log.solve_time );
  printf("gmres_initial_residual = %e;\n", gmres_gpu_1_log.initial_residual );
  printf("gmres_final_residual = %e;\n", gmres_gpu_1_log.final_residual );
  ...
  printf("\nGPU fgmres_housholder v0.2 ======================:\n\n");
  data_d_gmres_log gmres_gpu_2_log;
  ...
  printf("maxthreads = %d numprocs = %d\n", maxthreads, numprocs );
  data_fgmres_householder_gpu_v_0_2( &Asparse, &rhs_vector, &x, &L, &Ucsr, &gmres_param, &gmres_gpu_2_log );
  ...
  printf("gmres_search_directions = %d;\n", gmres_gpu_2_log.search_directions );
  printf("gmres_solve_time = %e;\n", gmres_gpu_2_log.solve_time );
  printf("gmres_initial_residual = %e;\n", gmres_gpu_2_log.initial_residual );
  printf("gmres_final_residual = %e;\n", gmres_gpu_2_log.final_residual );
  ...
  printf("\nGPU fgmres_housholder v0.3 ======================:\n\n");
  data_d_gmres_log gmres_gpu_3_log;
  ...
  printf("maxthreads = %d numprocs = %d\n", maxthreads, numprocs );
  data_fgmres_householder_gpu_v_0_3( &Asparse, &rhs_vector, &x, &L, &Ucsr, &gmres_param, &gmres_gpu_3_log );
  ...
  printf("gmres_search_directions = %d;\n", gmres_gpu_3_log.search_directions );
  printf("gmres_solve_time = %e;\n", gmres_gpu_3_log.solve_time );
  printf("gmres_initial_residual = %e;\n", gmres_gpu_3_log.initial_residual );
  printf("gmres_final_residual = %e;\n", gmres_gpu_3_log.final_residual );
