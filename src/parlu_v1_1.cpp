...
data_ParLU_v1_1(data_d_matrix * A, data_d_matrix * L, data_d_matrix * U)
{
  ...
  printf(
    "%% ParLU v1.1 used %d OpenMP threads and required %d iterations, %f wall clock seconds, and an average of %f wall clock seconds per iteration as measured by omp_get_wtime()\n",
