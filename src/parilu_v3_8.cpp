...
data_PariLU_v3_8(data_d_matrix * A, data_d_matrix * L, data_d_matrix * U, int tile)
{
  ...
  printf(
    "%% PariLU v3.8 used %d OpenMP threads and required %d iterations, %f wall clock seconds, and an average of %f wall clock seconds per iteration as measured by omp_get_wtime()\n",
